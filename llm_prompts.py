...
Example 3:
Abstract: "Association of severity of coexisting patellofemoral disease with increased impairments and functional limitations in patients with knee osteoarthritis. OBJECTIVE To evaluate the association between severity of coexisting patellofemoral (PF) disease with lower extremity impairments and functional limitations in patients with tibiofemoral (TF) osteoarthritis (OA). METHODS Radiographic views of the TF and PF compartments, knee extension strength, and knee range of motion were obtained for 167 patients with knee OA."
Output: ["patients with knee osteoarthritis .", "patients with tibiofemoral ( TF ) osteoarthritis ( OA ) .", "167 patients with knee OA ."]
...
Output: ["race-discordant patient-provider", "African American patients and wh
